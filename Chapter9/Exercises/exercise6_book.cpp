/*
   ...
   Added ==, != and << operators to the Book class from Exercise 5.
*/
...
int main()
try {
   Book test1 {"456-4563-212-C", "TESTING", "Mustafa Adaoglu", 2021};
   Book test2 {"457-6548-2236-D", "FURTHER TESTING", "Mustafa Adaoglu", 2021};
